...
export default function BloodPressureChart({ data }: BloodPressureChartProps) {
  ...
  return (
    <div className="bg-[#F4F0FE] 2xl:w-[45.375rem] rounded-2xl p-1 grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
      <div className="col-span-1 lg:col-span-2 px-1 py-2 xl:p-2">
        <div className="flex items-center justify-between mb-3 max-sm:px-1">
      ...
      {/* right side  */}
      <div className="col-span-1 flex flex-col justify-start gap-4 max-sm:pb-4 p-2">
